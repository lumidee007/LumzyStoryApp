                                ...
                                echo "
                                    <div class='col' id='$row[content_id]'>
                                        <div class='card h-100'>
                                            ...
                                            <p class='.upload-info' style='color: orangered; font-size: 14px; margin-left: 2px; '><i class='fas fa-user'> Posted by: $home_user, <span style='margin-left:auto'>$row[content_uploadDate]</span></i> </p>
                                            <div class='card-body'>
